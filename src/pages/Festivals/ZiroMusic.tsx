  ...
  return (
    <div className="pt-20 bg-white text-gray-900 min-h-screen">
      ...
      <section className="max-w-5xl mx-auto px-6 py-16">
        <h1 className="text-5xl font-bold mb-6">Ziro Music Festival</h1>
        <p className="text-gray-700 mb-10 max-w-3xl">
          Experience the unique blend of music, culture, and nature at the Ziro
          Music Festival. Book your spot now!
        </p>
        ...
        <section id="booking" className="max-w-5xl mx-auto px-6 py-16">
          <div className="bg-gradient-to-br from-white via-gray-50 to-gray-100 rounded-2xl shadow-2xl p-10 border border-gray-200">
            <h2 className="text-4xl font-bold text-center mb-10 text-gray-900">
              Book Your Ziro Music Festival Adventure
            </h2>
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <option value="Itanagar">Itanagar – ₹4999</option>
                  <option value="Naharlagun">Naharlagun – ₹4599</option>
                  <option value="Ziro">Ziro – ₹3999</option>
                </select>
