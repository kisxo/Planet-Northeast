...
import ziroImg from "@/assets/ZiroValley.png";
          ...
          <div className="container mx-auto px-6">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground">
                Discover breathtaking locations around the globe. From ancient
                wonders to modern marvels, find your next adventure.
              </p>
            </div>
          </div>
        </section>
